...
<div class="tabbable" style="margin-bottom: 9px;">
	...
	<li<?php echo ($action == 'customer')?' class="active"':'' ?>><?php echo anchor($module[0].'/update/customer/'.$data[0]->cus_idx,'Customer')?></li>
	<li<?php echo ($action == 'paket')?' class="active"':'' ?>><?php echo anchor($module[0].'/update/paket/'.$data[0]->cus_idx,'paket')?></li>
	<li<?php echo ($action == 'key')?' class="active"':'' ?>><?php echo anchor($module[0].'/update/key/'.$data[0]->cus_idx,'key')?></li>
    </ul>

...
<table>
    ...
    <tr>
        <td><?php echo form_text('Schedule Date & time','sched_date_time',(isset($data[0]->sched_date_time))?date('d-M-Y ;l',strtotime($data[0]->sched_date_time)):'','class="span2" id="date_time" autocomplete="off"');?></td>
        <td>&nbsp;</td>
